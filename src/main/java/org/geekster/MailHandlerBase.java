...
public class MailHandlerBase {
    ...
    public void sendMail()
    {
        ...
        try {
            ...
            mailMessage.setSubject("Anvesh Mailing class");
            mailMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("kaushaldikondwar8628@gmail.com"));
            mailMessage.setText("Anvesh is trying to teach mailing through java!!!");
